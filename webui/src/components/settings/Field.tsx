...
export function Field({
  ...
  return (
    // text-[13px] text-[var(--text)] on the <label> itself, not just on the
    // spans: the hint and error below set their own colour but not their own
    // size, so without this they inherit the 15px of :root. The label-text
    // span overrides size and colour for itself.
    <label className="flex flex-col gap-1.5 text-[13px] text-[var(--text)]">
