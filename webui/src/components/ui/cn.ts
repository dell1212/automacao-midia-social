 ...
 * (which Tailwind emits into a later block of the stylesheet, same trick as
 * `[&>button+button]:ml-0` elsewhere in this codebase) or restructure things
 * so the shared primitive does not set the property the caller needs to
 * change.
 */
